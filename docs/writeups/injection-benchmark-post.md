...
The complete [model card](../results/portfolio-v2.md) includes Wilson intervals, paired prompt deltas, operational controls, limitations, and the non-promotion decision. The [public evidence bundle](../results/portfolio-v2-evidence/) contains every generated output and score primitive needed to regenerate the report offline. The implementation, fixtures, and verification commands are in the [news-briefing repository](https://github.com/elanthus/news-briefing).
