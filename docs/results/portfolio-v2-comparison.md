...
Under the current promotion rule, the candidate meets the attack non-inferiority margin for both models but misses the minimum utility improvement for both. The do-not-promote outcomes are unchanged.
