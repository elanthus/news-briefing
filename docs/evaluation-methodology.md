...
As of 2026-08-14, all 81 offline checker/feed cases had completed blinded independent human review and repository-owner adjudication. On 2026-08-25, occurrence-blind URL mutations were repaired in `structure-overfilled` and `selection-category-ambiguity`; those two corrected fixtures are provisional pending renewed independent review, while the other 79 retain validation. The final 26-case packet covered 24 paired heuristic boundaries and two UTF-32 security regressions; it produced 23 exact agreements and three adjudicated disagreements, with two final quotation-label changes. Machine review was retained only as supporting evidence and was not counted as human approval.
